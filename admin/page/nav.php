...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Vinpearl Resort</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <!-- SidebarSearch Form -->
      <div class="form-inline user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="fas fa-user-secret nav-icon ml-2"></i>
                        <p>
                            Nhân viên
                            <i class="fas fa-angle-left right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="master.php?act=page_dmnv" class="nav-link">
                                <i class="fas fa-arrow-right nav-icon ml-3"></i>
                                <p>Chức vụ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="master.php?act=page_dsnv" class="nav-link">
                                <i class="fas fa-arrow-right nav-icon ml-3"></i>
                                <p>Thông tin</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="fas fa-tree nav-icon ml-2"></i>
                        <p>
                            Dịch vụ
                            <i class="fas fa-angle-left right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="master.php?act=page_loaidv" class="nav-link">
                                <i class="fas fa-arrow-right nav-icon ml-3"></i>
                                <p>Loại dịch vụ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="master.php?act=page_dsdv" class="nav-link">
                                <i class="fas fa-arrow-right nav-icon ml-3"></i>
                                <p>Thông tin</p>
                            </a>
                        </li>
