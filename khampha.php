...
<?php
    ...
    $query= "SELECT * FROM `dichvu` WHERE id_loai=3 LIMIT $begin,8";//bắt đầu từ begin lấy 8 sản phẩm trên 1 trang
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="khampha.php" class="dropdown-item active ">Khám phá & Hoạt động</a>
        ...
        <div class="container">
            ...
            <div id="div1" class="row text-center py-5">
                ...
                <style type="text/css">
                    ...
                    <?php 
                        $sql_trang= mysqli_query($conn,"SELECT * FROM `dichvu` where id_loai=3");
                    ...
                    <ul class="list_trang">
                        ...
                        for($i=1; $i<=$trang;$i++){
                        ?>
                        <li><a href="khampha.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
