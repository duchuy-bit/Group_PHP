...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
    ...
    <form method= "get">
        <table align="center">
            ...
            <tr>
                <td align="right">
                    <a style="color:pink" >phep tinh : </a>
                </td>
                <td>
                    <a style="color: red;"> 
                    <?php
            ...
            <tr>
                <td align="right">
                    <a style="color:pink;font-weight: bold;">So 1 : </a>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <a style="color:pink;font-weight: bold;">So 2 : </a> 
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <a style="color:pink;font-weight: bold;">Ket Qua : </a> 
                </td>
                <td>
                    <input type= "text" name= "r" 
                        value="<?php
                            echo tinhtoan($_GET['a'],$_GET['b'],$_GET['pheptinh'])
                        ?>"   readonly>
                </td>
            </tr>
            ...
            <?php
                ...
                function tinhtoan($a, $b, $c){
                    ...
                    if ($c=== "Cong") return $af[0];
                    if ($c=== "Tru") return $af[1];
                    if ($c=== "Nhan") return $af[2];
                    if ($c=== "Chia") return $af[3];
                }
