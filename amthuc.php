...
<?php
    ...
    $query= "SELECT * FROM `dichvu` WHERE id_loai=2 LIMIT $begin,8";//bắt đầu từ begin lấy 8 sản phẩm trên 1 trang
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="amthuc.php" class="dropdown-item active ">Ẩm thực</a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div id="div1" class="row text-center py-5">
                ...
                <style type="text/css">
                    ...
                    <?php 
                        $sql_trang= mysqli_query($conn,"SELECT * FROM `dichvu` where id_loai=2");
                        $row_count = mysqli_num_rows($sql_trang);//đếm số lượng phần tử trong sql
                        $trang = ceil($row_count/6); // ceil làm tròn số, tổng số chia 8
                    ?>
                    <ul class="list_trang">
                        <?php
                        for($i=1; $i<=$trang;$i++){
                        ?>
                        <li><a href="amthuc.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
