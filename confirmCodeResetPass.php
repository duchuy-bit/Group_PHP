...
$s = $_SESSION["forgotpass"];

if (isset($_POST['submit'])){
    echo $_POST['code']." ".$s;
    $code = $_POST['code'];
    if (password_verify($s, $_POST['code'])){
?>
    <script>window.location.href = "inputemail.php";</script>
<?php
    }else {
        echo "<script type='text/javascript'>alert('Sai mã xác thực $code');</script>";
    }
}
// echo $s;
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Code verify" 
                                                name='code'
                                                type="text"
