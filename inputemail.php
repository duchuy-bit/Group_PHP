<?php
    ...
    if (isset($_POST['reset'])){
        ...
        if ($d==0){
            ...
            $message = 'Mã xác thực tài khoản của bạn là: '.$s; // Could also be $message = $_POST['message']; 
            $headers = implode("\r\n", [
            'From: Tour Booking <nhom3@gmail.com>',
            ...
            if ($result){
                ...
                ?>
                    <script>window.location.href = "confirmCodeResetPass.php";</script>
                <?php
            }else{
